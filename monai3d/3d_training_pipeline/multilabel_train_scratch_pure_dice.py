...
def main(cfg):
    ...
    cfg.output_dir = '/root/UWMGI/monai3d/output/pure/'
...
if __name__ == "__main__":
    ...
    parser.add_argument("-c", "--config", default="cfg_unet_multilabel_scratch_pure", help="config filename")
    parser.add_argument("-f", "--fold", type=int, default=0, help="fold")
    parser.add_argument("-s", "--seed", type=int, default=12, help="seed")
